...
.stat-left { display: flex; gap: 1.5rem; align-items: flex-start; flex-wrap: wrap; }
...
.balance-row { display: flex; align-items: baseline; gap: 0.8rem; }
.balance-row {
